...
GREEN_TAXI_PARQUET_FILE_TEMPLATE = (
    AIRFLOW_HOME + "/green_tripdata_{{ execution_date.strftime('%Y-%m') }}.parquet"
)
...
FHV_TAXI_URL_TEMPLATE = (
    URL_PREFIX + "/fhv_tripdata_{{ execution_date.strftime('%Y-%m') }}.csv"
)
FHV_TAXI_CSV_FILE_TEMPLATE = (
    AIRFLOW_HOME + "/fhv_tripdata_{{ execution_date.strftime('%Y-%m') }}.csv"
)
