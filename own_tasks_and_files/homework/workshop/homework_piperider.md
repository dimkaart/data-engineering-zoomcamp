...
### Answer 1:
The distribution between vendor id [2,1,4] is `60.1/39.5/0.4` (more precisely `60.0/39.5/0.4`).
![alt text](../../images/piperider_1.png)
...
### Answer 2:
The composition of the column total amount in the order of positive/zero/negative is `61.4M/25K/160.6K` (more precisely `61.3M/28.5K/160.6K`).
![alt text](../../images/piperider_2.png)
...
### Answer 3:
The numeric statistics (average/standard deviation/min/max/sum) of trip distances is `2.95/35.43/-23.88/167.3K/181.5M` (more precisely `2.97/36/-23.88/167.3K/182.6M`).
![alt text](../../images/piperider_3.png)
